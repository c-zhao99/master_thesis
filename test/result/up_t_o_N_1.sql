CREATE TABLE Employee (
    ...
    CONSTRAINT Manager CHECK ((TYPE_Manager = 1 AND TeamName IS NOT NULL AND Promote_Engineer_EmployeeID IS NOT NULL) OR (TYPE_Manager = 0 AND TeamName IS NULL AND Promote_Engineer_EmployeeID IS NULL)),

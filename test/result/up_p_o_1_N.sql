CREATE TABLE Employee (
    ...
    CONSTRAINT Manager CHECK ((TYPE_Manager = 1 AND TeamName IS NOT NULL) OR (TYPE_Manager = 0 AND TeamName IS NULL AND PlanWith_Manager_EmployeeID IS NULL AND PlanWith_Manager_Year IS NULL)),
...
CREATE TABLE Customer (
    ...
    Interract_ProductManager_EmployeeID {ADD_TYPE} UNIQUE REFERENCES Employee(EmployeeID),

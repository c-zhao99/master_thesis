...
CREATE TABLE Interract (
    ...
    Interract_GovOfficial_GovID {ADD_TYPE} UNIQUE NOT NULL REFERENCES GovOfficial(GovID),
    PRIMARY KEY (Interract_Engineer_EmployeeID,Interract_GovOfficial_GovID)
);
